...
import { DiscussEditComponent } from "./discuss-edit.component"

describe('DiscussHomeComponent', () => {
  let discussStartComponent: DiscussEditComponent
  ...
  it('should create an instance of DiscussEditComponent', () => {
